      ...
      <Container>
        <Grid container justifyContent={"center"} textAlign={"center"}>
          ...
          <Grid item xs={12} md={3}>
            <P>
              Nosso foco é te ajudar a conquistar a sonhada aprovação na OAB.
              Desta forma, investimos pesado todos os anos em tecnologia e
              didática. Com a plataforma B.I.P.E, você se preocupa apenas com
              estudar e fazer os exercícios, ela cuida da organização para você.
            </P>
          </Grid>
          <Grid container spacing={2} marginTop={2}>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                <P>
                  ...
                  Nossos pilares: Saber + Praticar + Revisar + Aprofundar (em
                  cada aula).
                </P>
              </DropDown>
            </Grid>
            ...
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                />
                <P>
                  Se preferir, organize e acompanhe seus estudos por um Planner
                  (cronograma) ou um Sumário (todas as aulas são temáticas).
                </P>
              </DropDown>
            </Grid>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                />
                <P>
                  Você poderá personalizar seu calendário, arrastando as aulas
                  para os dias desejados e até recalcular sua rota de estudos.
                </P>
              </DropDown>
            </Grid>
            <Grid item xs={12} md={3}>
          ...
          <Grid container spacing={2} marginTop={2}>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                <img
                  ...
                  alt="circled-chevron-down"
                />
                <P>Legislação, glossário e jurisprudência, por tema da aula.</P>
              </DropDown>
            </Grid>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                />
                <P>
                  Sabe aquela dúvida da aula? Disponibilizamos um canal direto
                  para você enviar a sua pergunta para nossos professores! Mesmo
                  para quem está online, estamos sempre juntos.
                </P>
              </DropDown>
            </Grid>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                <P>
                  ...
                  precisa melhorar. Comunidade MeuCurso - conecte-se aos seus
                  amigos de rota. App MeuCurso - aplicativo exclusive com o
                  conteúdo da rota de estudos, inclusive permite assistir aula
                  off-line..
                </P>
              </DropDown>
            </Grid>
            <Grid item xs={12} md={3}>
              <DropDown>
                ...
                />
                <P>
                  Simular a prova no formato OAB/FGV faz diferença na evolução
                  da performance.
                </P>
              </DropDown>
            </Grid>
