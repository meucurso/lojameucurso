    ...
    >
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Card1 sx={{ mb: 3 }}>
            <FlexBetween>
              <Heading number={2} title="Endereço de Entrega" />

              <NewAddressForm setNewAddress={setNewAddress} />
            </FlexBetween>

            <Typography mb={1.5}>Endereço de entrega</Typography>
            <Grid container spacing={3}>
          ...
          <Card1 sx={{ mb: 3 }}>
            <Heading number={3} title="Datalhes de Pagamento" />

            <Box mb={3.5}>
              <Typography mb={1.5}>
                Digite as informações de seu cartão
              </Typography>
              <Grid container spacing={3}>
                <Grid item sm={6} xs={12}>
                  <TextField
                ...
                <Grid item sm={12} xs={12}>
                  <Box display="flex" justifyContent="space-between">
                    ...
                    <TextField
                      ...
                      helperText={
                        (touched.cardCVC && errors.cardCVC) as string
                      }
                    />
                  </Box>
                </Grid>
            ...
            <Box>
              <Typography mb={1.5}>Cartões Salvos</Typography>
